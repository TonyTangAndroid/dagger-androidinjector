...
public abstract class NoteDetailModule {
    ...
    @Binds
    abstract NoteDetailView provideFeatureView(NoteDetailActivity featureActivity);

    @Provides @Named("someId") static String provideSomeId(NoteDetailActivity featureActivity) {
